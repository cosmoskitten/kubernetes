...
func NewCMServer() *CMServer {
	s := CMServer{
		KubeControllerManagerConfiguration: componentconfig.KubeControllerManagerConfiguration{
			...
			APIServerHealthCheckPeriod:        unversioned.Duration{Duration: 0 * time.Second},
...
func (s *CMServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&s.APIServerHealthCheckPeriod.Duration, "apiserver-health-check-period", s.APIServerHealthCheckPeriod.Duration, "Period for checking the the health of all API servers (set to 0 to disable)")
