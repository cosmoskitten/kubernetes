...
func Run(s *options.CMServer) error {
	...
	kubeClient, leaderElectionClient, kubeconfig, err := createClient(s)
	if err != nil {
		return err
	}
...
func createClient(s *options.CMServer) (*clientset.Clientset, *clientset.Clientset, *restclient.Config, error) {
