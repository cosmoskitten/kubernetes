...
func NewCmdUpgrade(out io.Writer) *cobra.Command {
	...
	cmd.PersistentFlags().BoolVar(&flags.allowExperimentalUpgrades, "allow-experimental-upgrades", flags.allowExperimentalUpgrades, "Show unstable versions as an upgrade alternative and allow upgrading to an unstable version")
	cmd.PersistentFlags().BoolVar(&flags.allowRCUpgrades, "allow-release-candidate-upgrades", flags.allowRCUpgrades, "Show release candidate versions as an upgrade alternative and allow upgrading to a release candidate version")
