...
func NewCmdInit(out io.Writer) *cobra.Command {
	...
	AddInitOtherFlags(cmd.PersistentFlags(), &cfgPath, &skipPreFlight, &skipTokenPrint)
...
func AddInitOtherFlags(flagSet *flag.FlagSet, cfgPath *string, skipPreFlight, skipTokenPrint *bool) {
	flagSet.StringVar(
