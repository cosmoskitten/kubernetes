...
func (i *Init) Run(out io.Writer) error {
	...
	if err := nodebootstraptokenphase.UpdateOrCreateToken(client, i.cfg.Token, false, i.cfg.TokenTTL, kubeadmconstants.DefaultTokenUsages, kubeadmconstants.DefaultTokenGroups, tokenDescription); err != nil {
		return err
	}
