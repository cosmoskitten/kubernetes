...
// NewKubeStaticPodPathManagerUsingTempDirs
...
func PerformStaticPodControlPlaneUpgrade(waiter apiclient.Waiter, pathMgr StaticPodPathManager, cfg *kubeadmapi.MasterConfiguration) error {
