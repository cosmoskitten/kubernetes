...
func BuildGenericConfig(s *options.ServerRunOptions) (*genericapiserver.Config, informers.SharedInformerFactory, clientgoinformers.SharedInformerFactory, *kubeserver.InsecureServingInfo, aggregatorapiserver.ServiceResolver, error) {
	...
	genericConfig.Authorizer, genericConfig.AuthorizationRulesGetter, err = BuildAuthorizer(s, sharedInformers)
	if err != nil {
...
func BuildAuthorizer(s *options.ServerRunOptions, sharedInformers informers.SharedInformerFactory) (authorizer.Authorizer, authorizer.AuthorizationRulesGetter, error) {
