...
func AddKubeletConfigFlags(fs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.DurationVar(&c.CPUManagerReconcileFrequency.Duration, "cpu-manager-reconcile-frequency", c.CPUManagerReconcileFrequency.Duration, "<Warning: Alpha feature> CPU Manager reconciliation frequency. Examples: '10s', or '1m'. If not supplied, defaults to 'NodeStatusUpdateFrequency'")
