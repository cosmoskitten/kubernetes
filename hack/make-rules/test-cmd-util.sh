...
run_initializer_tests() {
  ...
  kubectl create -f hack/testdata/initializer-configuration.yaml 2>&1 "${kube_flags[@]}"
  kube::test::get_object_assert initializerconfiguration "{{range.items}}{{$id_field}}{{end}}" 'test-initializer'
