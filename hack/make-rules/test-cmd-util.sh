...
IMAGE_STATEFULSET_R1="gcr.io/google-containers/pause:latest"
IMAGE_STATEFULSET_R2="gcr.io/google-containers/nginx:test-cmd"
...
run_statefulset_history_tests() {
  ...
  # Clean up - delete either one suffices
