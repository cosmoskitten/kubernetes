...
readonly master_logfiles="kube-apiserver kube-scheduler rescheduler cloud-controller-manager kube-controller-manager etcd etcd-events glbc cluster-autoscaler kube-addon-manager fluentd"
