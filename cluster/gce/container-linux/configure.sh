...
function install-kube-binary-config {
  ...
  if [[ "${NETWORK_PROVIDER:-}" == "kubenet" ]] || \
    ...
    local -r cni_tar="cni-plugins-amd64-v0.6.0.tgz"
    local -r cni_sha1="d595d3ded6499a64e8dac02466e2f5f2ce257c9f"
    download-or-bust "${cni_sha1}" "https://github.com/containernetworking/plugins/releases/download/${cni_version}/${cni_tar}"
