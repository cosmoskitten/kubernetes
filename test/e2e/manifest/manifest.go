...
func PodFromManifest(filename string) (*v1.Pod, error) {
	...
	if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), json, &pod); err != nil {
		return nil, err
	}
	return &pod, nil
}
...
func RcFromManifest(fileName string) (*v1.ReplicationController, error) {
	...
	if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), json, &controller); err != nil {
		return nil, err
	}
...
func SvcFromManifest(fileName string) (*v1.Service, error) {
	...
	if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), json, &svc); err != nil {
		return nil, err
	}
	return &svc, nil
}
...
func IngressFromManifest(fileName string) (*extensions.Ingress, error) {
	...
	if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), json, &ing); err != nil {
		return nil, err
	}
	return &ing, nil
}
...
func StatefulSetFromManifest(fileName, ns string) (*apps.StatefulSet, error) {
	...
	if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), json, &ss); err != nil {
		return nil, err
	}
	ss.Namespace = ns
