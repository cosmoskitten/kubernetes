...
func NewTestJob(behavior, name string, rPol v1.RestartPolicy, parallelism, completions int32, activeDeadlineSeconds *int64, backoffLimit int32, backoffSeconds int64) *batch.Job {
	job := &batch.Job{
