...
var _ = framework.KubeDescribe("DNS", func() {
	...
	It("should provide DNS for ExternalName services", func() {
		...
		/* Below test case is disabled for v1.7 k8s due to https://github.com/kubernetes/kubernetes/issues/35354.
		   It is enabled for v1.8+ k8s where the fix is in place.
