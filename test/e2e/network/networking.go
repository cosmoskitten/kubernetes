...
var _ = SIGDescribe("Networking", func() {
	...
	It("should provide Internet connection for containers [Feature:Networking-IPv4][Conformance]", func() {
		By("Running container which tries to ping 8.8.8.8")
		framework.ExpectNoError(
			framework.CheckConnectivityToHost(f, "", "ping-test", "ping", "8.8.8.8", 30))
	})
	...
	It("should provide Internet connection for containers [Feature:Networking-IPv6][Experimental]", func() {
		...
		framework.ExpectNoError(
			framework.CheckConnectivityToHost(f, "", "ping-test", "ping6", "google.com", 30))
	})
