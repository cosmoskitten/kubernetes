...
var _ = framework.KubeDescribe("kube-proxy migration [Feature:KubeProxyDaemonSetMigration]", func() {
	...
	SIGDescribe("Upgrade kube-proxy from static pods to a DaemonSet", func() {
	...
	SIGDescribe("Downgrade kube-proxy from a DaemonSet to static pods", func() {
