...
*/
func TestStuff(t *Testing.T) {
}`, []Test{{"test/list/main_test.go:10:1", "k8s.io/kubernetes/test/list", "TestStuff", `   Testname: Kubelet-OutputToLogs
   Description: By default the stdout and stderr from the process
   being executed in a pod MUST be sent to the pod's logs.
`}},
	},
...
var _ = Describe("Feature", func() {
	...
	It("should work properly", func() {})
})`, []Test{{"e2e/foo.go:5:2", "[k8s.io] Feature", "should work properly", "It should have comment\n"}},
	},
	// KubeDescribe + It
	{"e2e/foo.go", `
var _ = framework.KubeDescribe("Feature", func() {
...
})`, []Test{{"e2e/foo.go:8:3", "[k8s.io] Feature when offline", "should work", `Testname: Kubelet-OutputToLogs
Description: By default the stdout and stderr from the process
being executed in a pod MUST be sent to the pod's logs.
`}},
	},
