...
func TestPatchWithCreateOnUpdate(t *testing.T) {
	...
	{
		endpointJSON, err := runtime.Encode(globalscheme.Codecs.LegacyCodec(v1.SchemeGroupVersion), endpointTemplate)
		if err != nil {
	...
	{
		endpointJSON, err := runtime.Encode(globalscheme.Codecs.LegacyCodec(v1.SchemeGroupVersion), createdEndpoint)
		if err != nil {
			t.Fatalf("Failed creating endpoint JSON: %v", err)
		}
