...
var etcdStorageData = map[schema.GroupVersionResource]struct {
	...
	gvr("events.k8s.io", "v1beta1", "events"): {
		stub:             `{"object": {"namespace": "etcdstoragepathtestnamespace"}, "involvedObject": {"namespace": "etcdstoragepathtestnamespace"}, "message": "some data here", "metadata": {"name": "event1"}, "eventTime": "2017-08-09T15:04:05.000000Z"}`,
		expectedEtcdPath: "/registry/events/etcdstoragepathtestnamespace/event1",
	},
	// --
