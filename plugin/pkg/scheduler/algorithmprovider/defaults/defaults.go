...
func defaultPredicates() sets.String {
	predSet := sets.NewString(
		...
		factory.RegisterFitPredicateFactory(
			"MaxEBSVolumeCount",
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxEBSVolumeCountPredicate(args.PVInfo, args.PVCInfo)
			},
		),
		...
		factory.RegisterFitPredicateFactory(
			"MaxGCEPDVolumeCount",
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxGCEPDVolumeCountPredicate(args.PVInfo, args.PVCInfo)
			},
		),
		...
		factory.RegisterFitPredicateFactory(
			...
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxAzureDiskVolumeCountPredicate(args.PVInfo, args.PVCInfo)
			},
		),
