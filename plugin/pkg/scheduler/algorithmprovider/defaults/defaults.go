...
func defaultPredicates() sets.String {
	predSet := sets.NewString(
		...
		factory.RegisterFitPredicateFactory(
			"MaxEBSVolumeCount",
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxPDVolumeCountPredicate(predicates.EBSVolume, args.PVInfo, args.PVCInfo)
			},
		),
		...
		factory.RegisterFitPredicateFactory(
			"MaxGCEPDVolumeCount",
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxPDVolumeCountPredicate(predicates.GCEPDVolume, args.PVInfo, args.PVCInfo)
			},
		),
		...
		factory.RegisterFitPredicateFactory(
			...
			func(args factory.PluginFactoryArgs) algorithm.FitPredicate {
				return predicates.NewMaxPDVolumeCountPredicate(predicates.AzureDiskVolume, args.PVInfo, args.PVCInfo)
			},
		),
