...
var (
	...
	ErrNodeUnderMemoryPressure   = newPredicateFailureError("NodeNotUnderMemoryPressure")
	ErrNodeUnderDiskPressure     = newPredicateFailureError("NodeNotUnderDiskPressure")
