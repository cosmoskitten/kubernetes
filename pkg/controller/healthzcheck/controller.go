...
// APIServerHealthCheckController is a controller which periodically checks each
...
// NewAPIServerHealthCheckController constructs an APIServerHealthCheckController with the provided endpoints
