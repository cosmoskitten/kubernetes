...
import (
	...
	basecontroller "k8s.io/client-go/tools/controller"
)

type PodControllerRefManager struct {
	basecontroller.BaseControllerRefManager
...
func NewPodControllerRefManager(
	...
	return &PodControllerRefManager{
		BaseControllerRefManager: basecontroller.BaseControllerRefManager{
