...
// ResetPVCCondition removes all conditions from a PVC
func ResetPVCCondition(pvc *v1.PersistentVolumeClaim, kubeClient clientset.Interface) (*v1.PersistentVolumeClaim, error) {
	glog.V(4).Infof("Restting PVC %s Conditions", ClaimToClaimKey(pvc))

	newConditions := []v1.PvcCondition{}
