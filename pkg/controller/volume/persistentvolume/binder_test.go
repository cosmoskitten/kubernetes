...
func TestSync(t *testing.T) {
	...
	tests := []controllerTest{
		...
		// PVC with VolumeMode
		{
			...
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-1", "uid14-1", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-1", "uid14-1", "1Gi", "volume14-1", v1.ClaimBound, nil)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-2", "uid14-1", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-2", "uid14-2", "1Gi", "volume14-2", v1.ClaimBound, nil)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withClaimVolumeMode(nil, newClaimArray("claim14-3", "uid14-3", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(nil, newClaimArray("claim14-3", "uid14-3", "1Gi", "volume14-3", v1.ClaimBound, nil)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-4", "uid14-4", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-4", "uid14-4", "1Gi", "volume14-4", v1.ClaimBound, nil)),
			noevents, noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeFile, newVolumeArray("volume14-5", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classGold)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-5", "uid14-5", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-5", "uid14-5", "1Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-6-1", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-6-1", "uid14-6-1", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-6-1", "uid14-6-1", "1Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(nil, newVolumeArray("volume14-6-2", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-6-2", "uid14-6-2", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-6-2", "uid14-6-2", "1Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			// failed syncVolume do not bind when pv is prebound even though volumeModes match
			"14-7 - do not bind when pv volume is prebound and volumeModes match",
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-7", "10Gi", "", "claim14-7", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-7", "uid14-7", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-7", "uid14-7", "1Gi", "", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-8", "10Gi", "", "", v1.VolumePending, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-8", "uid14-8", "1Gi", "volume14-8", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeFile, newClaimArray("claim14-8", "uid14-8", "1Gi", "volume14-8", v1.ClaimPending, nil)),
			[]string{"Normal FailedBinding"},
			noerrors, testSyncClaim,
		},
		{
			// syncVolume binds when pvc is prebound to pv with matching volumeModes
			"14-9 - bind when pvc is prebound to pv with matching volumeModes",
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-9", "10Gi", "uid14-9", "claim14-9", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-9", "uid14-9", "1Gi", "volume14-9", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-9", "uid14-9", "1Gi", "volume14-9", v1.ClaimBound, nil, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
		{
			// syncVolume binds when pv is prebound to pvc with matching volumeModes
			"14-10 - bind when pv is prebound to pvc with matching volumeModes",
			...
			withVolumeVolumeMode(&modeBlock, newVolumeArray("volume14-10", "10Gi", "uid14-9", "claim14-10", v1.VolumeBound, v1.PersistentVolumeReclaimRetain, classEmpty)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-10", "uid14-10", "1Gi", "", v1.ClaimPending, nil)),
			withClaimVolumeMode(&modeBlock, newClaimArray("claim14-10", "uid14-10", "1Gi", "volume14-9", v1.ClaimBound, nil, annBindCompleted)),
			noevents, noerrors, testSyncClaim,
		},
	}
