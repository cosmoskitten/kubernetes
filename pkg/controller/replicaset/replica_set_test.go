...
func TestStatusUpdatesWithoutReplicasChange(t *testing.T) {
	...
	response := runtime.EncodeOrDie(testapi.Apps.Codec(), &apps.ReplicaSet{})
	...
	updatedRc := runtime.EncodeOrDie(testapi.Apps.Codec(), rs)
	fakeHandler.ValidateRequest(t, testapi.Apps.ResourcePath(replicaSetResourceName(), rs.Namespace, rs.Name)+"/status", "PUT", &updatedRc)
}
...
func TestControllerUpdateReplicas(t *testing.T) {
	...
	decRc := runtime.EncodeOrDie(testapi.Apps.Codec(), rs)
	fakeHandler.ValidateRequest(t, testapi.Apps.ResourcePath(replicaSetResourceName(), rs.Namespace, rs.Name)+"/status", "PUT", &decRc)
...
func TestReadyReplicas(t *testing.T) {
	...
	decRs := runtime.EncodeOrDie(testapi.Apps.Codec(), rs)
	fakeHandler.ValidateRequest(t, testapi.Apps.ResourcePath(replicaSetResourceName(), rs.Namespace, rs.Name)+"/status", "PUT", &decRs)
	validateSyncReplicaSet(t, &fakePodControl, 0, 0, 0)
}
