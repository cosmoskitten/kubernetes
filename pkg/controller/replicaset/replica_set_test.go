...
// Get a list of names that identify RSs queued for syncing after a pod add/update operation
...
func TestOverlappingRSs(t *testing.T) {
	...
	manager.addPod(pod)
	// Obtain names of RSs matching the pod manually
	...
	// Obtain queued RS's namespace/name key
