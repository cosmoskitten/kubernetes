...
func (n *NsenterMounter) makeNsenterArgs(source, target, fstype string, options []string) []string {
	...
	if systemdRunPath, hasSystemd := n.ne.SupportSystemd(); hasSystemd {
...
func (n *NsenterMounter) PathIsDevice(pathname string) (bool, error) {
	pathType, err := n.GetMountPathType(pathname)
...
func (mounter *NsenterMounter) GetMountPathType(pathname string) (MountPathType, error) {
