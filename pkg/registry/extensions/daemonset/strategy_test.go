...
func TestSelectorImmutability(t *testing.T) {
	tests := []struct {
		...
		{"GET", "/apis/apps/v1beta2/namespaces", map[string]string{"a": "b"}, map[string]string{"c": "d"}, "apps", "v1beta2", map[string]string{"a": "b"}},
		{"GET", "/apis/extensions/v1beta1/namespaces", map[string]string{"a": "b"}, map[string]string{"c": "d"}, "extensions", "v1beta1", map[string]string{"c": "d"}},
	}
