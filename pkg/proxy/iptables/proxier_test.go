...
func TestOnlyLocalLoadBalancing(t *testing.T) {
	...
	makeServiceMap(fp,
		makeTestService(svcPortName.Namespace, svcPortName.Name, func(svc *api.Service) {
			...
			svc.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
		}),
	)
	...
	services := []*api.Service{
		...
		makeTestService("somewhere", "only-local-load-balancer", func(svc *api.Service) {
			svc.ObjectMeta.Annotations = map[string]string{
				...
				annotations.BetaAnnotationHealthCheckNodePort: "345",
			}
			svc.Spec.Type = api.ServiceTypeLoadBalancer
