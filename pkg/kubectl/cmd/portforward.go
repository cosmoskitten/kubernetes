...
func NewCmdPortForward(f cmdutil.Factory, cmdOut, cmdErr io.Writer) *cobra.Command {
	...
	cmd.Flags().StringP("address", "a", "localhost", "Address to listen on")
	// TODO support UID
	return cmd
}
...
func (f *defaultPortForwarder) ForwardPorts(method string, url *url.URL, opts PortForwardOptions) error {
	...
	fw, err := portforward.NewOnAddress(dialer, opts.Address, opts.Ports, opts.StopChannel, opts.ReadyChannel, f.cmdOut, f.cmdErr)
	if err != nil {
		return err
	}
...
func (o *PortForwardOptions) Complete(f cmdutil.Factory, cmd *cobra.Command, args []string) error {
	...
	o.Address = cmdutil.GetFlagString(cmd, "address")
