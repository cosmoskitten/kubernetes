...
func (f *discoveryFactory) BindDiscoveryFlags(flags *pflag.FlagSet) {
...
func (f *ring0Factory) BindDiscoveryFlags(flags *pflag.FlagSet) {
	f.discoveryFactory.BindDiscoveryFlags(flags)
}
