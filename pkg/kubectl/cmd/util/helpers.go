...
func AddIncludeUninitializedFlag(cmd *cobra.Command) {
	cmd.Flags().Bool(IncludeUninitializedFlag, false, "If true, include the object(s) that have not been initialized yet. Only objects with empty metadata.initializers are regarded as initialized.")
}
