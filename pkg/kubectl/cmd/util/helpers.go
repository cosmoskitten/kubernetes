...
func AddValidateFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool("openapi", true, "If true, use openapi rather than swagger when possible")
...
func AddValidateOptionFlags(cmd *cobra.Command, options *ValidateOptions) {
	...
	cmd.Flags().BoolVar(&options.UseOpenAPI, "openapi", true, "If true, use openapi rather than swagger when possible")
	cmd.MarkFlagFilename("schema-cache-dir")
}
