...
func (d *CachedDiscoveryClient) ServerResourcesForGroupVersion(groupVersion string) (*metav1.APIResourceList, error) {
	...
	if err == nil {
		...
		if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), cachedBytes, cachedResources); err == nil {
...
func (d *CachedDiscoveryClient) ServerGroups() (*metav1.APIGroupList, error) {
	...
	if err == nil {
		...
		if err := runtime.DecodeInto(globalscheme.Codecs.UniversalDecoder(), cachedBytes, cachedGroups); err == nil {
			glog.V(6).Infof("returning cached discovery info from %v", filename)
...
func (d *CachedDiscoveryClient) writeCachedFile(filename string, obj runtime.Object) error {
	...
	bytes, err := runtime.Encode(globalscheme.Codecs.LegacyCodec(), obj)
	if err != nil {
		return err
	}
