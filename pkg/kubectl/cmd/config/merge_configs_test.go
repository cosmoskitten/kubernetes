...
func TestMergingOnlyContexts(t *testing.T) {
	tconf := clientcmdapi.Config{
...
func TestMergingOnlyClusters(t *testing.T) {
	tconf := clientcmdapi.Config{
		CurrentContext: "any-context",
...
func TestMergingOnlyAuthInfo(t *testing.T) {
	tconf := clientcmdapi.Config{
		CurrentContext: "any-context",
...
func TestMergingWithConflict(t *testing.T) {
...
func (test mergeConfigsTest) run(t *testing.T) {
	...
	cmd := NewCmdConfigMergeConfigs(buf, options.configAccess)
	if test.target != "" {
	...
	err = options.RunMergeContexts(buf)
