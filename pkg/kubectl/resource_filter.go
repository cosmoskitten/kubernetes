...
func DecodeUnknownObject(obj runtime.Object) (runtime.Object, error) {
	...
	case runtime.Unstructured, *runtime.Unknown:
		if objBytes, err := runtime.Encode(globalscheme.Codecs.LegacyCodec(), obj); err == nil {
			if decodedObj, err := runtime.Decode(globalscheme.Codecs.UniversalDecoder(), objBytes); err == nil {
				obj = decodedObj
			}
		}
	}
