...
func (m *Helper) List(namespace, apiVersion string, labelSelector labels.Selector, fieldSelector fields.Selector, export, includeUninitialized bool) (runtime.Object, error) {
