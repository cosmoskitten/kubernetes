...
// DaemonSetGeneratorExtensionsV1Beta1 supports stable generation of a daemonset
type DaemonSetGeneratorExtensionsV1Beta1 struct {
	BaseGenerator
}

// Ensure it supports the generator pattern that uses parameters specified during construction
var _ StructuredGenerator = &DaemonSetGeneratorExtensionsV1Beta1{}

// StructuredGenerate outputs a daemonset object using the configured fields
func (s *DaemonSetGeneratorExtensionsV1Beta1) StructuredGenerate() (runtime.Object, error) {
...
// DaemonSetGeneratorAppsV1Beta2 supports stable generation of a daemonset
type DaemonSetGeneratorAppsV1Beta2 struct {
	BaseGenerator
}

// Ensure it supports the generator pattern that uses parameters specified during construction
var _ StructuredGenerator = &DaemonSetGeneratorAppsV1Beta2{}

// StructuredGenerate outputs a daemonset object using the configured fields
func (s *DaemonSetGeneratorAppsV1Beta2) StructuredGenerate() (runtime.Object, error) {
	podSpec, labels, selector, err := s.structuredGenerate()
