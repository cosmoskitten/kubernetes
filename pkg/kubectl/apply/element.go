...
type FieldMeta interface {
	// MergeType specifies how a field should be merged.  One of
	// replace, merge, replace-keys
	GetFieldMergeType() string
	// MergeKey specifies which fields to use in order to merge items
	// in lists
...
// IsDrop returns true if the field represented by e should have the local value directly
