...
func encodeOrDie(obj runtime.Object) []byte {
	data, err := runtime.Encode(globalscheme.Codecs.LegacyCodec(api.SchemeGroupVersion), obj)
	if err != nil {
		panic(err.Error())
	}
	return data
...
func TestSortingPrinter(t *testing.T) {
	...
	for _, test := range tests {
		sort := &SortingPrinter{SortField: test.field, Decoder: globalscheme.Codecs.UniversalDecoder()}
