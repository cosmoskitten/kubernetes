	...
	testCases := []fakeHostPathTypeChecker{
		{
			...
			isDir:         true,
			exists:        true,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathDirectoryOrCreate), string(v1.HostPathDirectory)),
		...
		},
		{
			...
			isDir:         false,
			exists:        false,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathDirectoryOrCreate)),
		...
		},
		{
			...
			isFile:        true,
			exists:        true,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathFileOrCreate), string(v1.HostPathFile)),
		...
		},
		{
			...
			isFile:        false,
			exists:        false,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathFileOrCreate)),
		...
		},
		{
			...
			isFile:        true,
			exists:        true,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathSocket), string(v1.HostPathFileOrCreate), string(v1.HostPathFile)),
			invalidpathType: newHostPathTypeList(string(v1.HostPathDirectoryOrCreate), string(v1.HostPathDirectory),
		...
		},
		{
			...
			isFile:        true,
			exists:        true,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathCharDev), string(v1.HostPathFileOrCreate), string(v1.HostPathFile)),
			invalidpathType: newHostPathTypeList(string(v1.HostPathDirectoryOrCreate), string(v1.HostPathDirectory),
		...
		},
		{
			...
			isFile:        true,
			exists:        true,
			validpathType: newHostPathTypeList(string(v1.HostPathUnset), string(v1.HostPathBlockDev), string(v1.HostPathFileOrCreate), string(v1.HostPathFile)),
			invalidpathType: newHostPathTypeList(string(v1.HostPathDirectoryOrCreate), string(v1.HostPathDirectory),
