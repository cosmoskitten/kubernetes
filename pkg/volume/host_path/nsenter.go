...
func (ftc *nsenterFileTypeChecker) IsBlock() bool {
	return ftc.checkMimetype(v1.HostPathBlockDev)
}

func (ftc *nsenterFileTypeChecker) IsChar() bool {
	return ftc.checkMimetype(v1.HostPathCharDev)
}

func (ftc *nsenterFileTypeChecker) IsSocket() bool {
	return ftc.checkMimetype(v1.HostPathSocket)
}
...
func (ftc *nsenterFileTypeChecker) checkMimetype(checkedType v1.HostPathType) bool {
