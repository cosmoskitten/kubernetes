...
func (b *hostPathMounter) SetUp(fsGroup *int64) error {
	...
	return checkType(b.GetPath(), b.pathType, b.containerized, b.mounter.GetMountPathType)
}
...
type fileTypeChecker interface {
	getFileType(pathname string, fileInfo os.FileInfo) (v1.HostPathType, error)
}
...
func checkType(path string, pathType *v1.HostPathType, containerized bool, checker Factory) error {
