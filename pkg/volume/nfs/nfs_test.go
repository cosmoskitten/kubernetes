...
func TestCanSupport(t *testing.T) {
	...
	plugMgr.InitPlugins(ProbeVolumePlugins(volume.VolumeConfig{}), nil, volumetest.NewFakeVolumeHost(tmpDir, nil, nil))
...
func TestPersistentClaimReadOnlyFlag(t *testing.T) {
	...
	plugMgr := volume.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(volume.VolumeConfig{}), nil, volumetest.NewFakeVolumeHost(tmpDir, client, nil))
