...
func TestCanSupport(t *testing.T) {
	...
	plugMgr.InitPlugins(ProbeVolumePlugins(), nil, volumetest.NewFakeVolumeHost(tmpDir, nil, nil))
...
func testPlugin(t *testing.T, tmpDir string, volumeHost volume.VolumeHost) {
	plugMgr := volume.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(), nil, volumeHost)
...
func TestPersistentClaimReadOnlyFlag(t *testing.T) {
	...
	plugMgr := volume.VolumePluginMgr{}
	plugMgr.InitPlugins(ProbeVolumePlugins(), nil, volumetest.NewFakeVolumeHost("/tmp/fake", client, nil))
