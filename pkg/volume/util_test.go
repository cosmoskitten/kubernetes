...
func TestChooseZonesForVolume(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			VolumeName: "henley-1",
			NumZones:   2,
			Expected:   sets.NewString("b" /* hash("henley") + 1 == 1 */, "c"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "henley-2",
		...
		},
		{
			...
			VolumeName: "henley-2",
			NumZones:   2,
			Expected:   sets.NewString("c" /* hash("henley") + 2 == 2 */, "a"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "henley-3",
		...
		},
		{
			...
			VolumeName: "henley-3",
			NumZones:   2,
			Expected:   sets.NewString("a" /* hash("henley") + 3 == 3 === 0 mod 3 */, "b"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "henley-4",
		...
		},
		{
			...
			VolumeName: "henley-4",
			NumZones:   2,
			Expected:   sets.NewString("b" /* hash("henley") + 4 == 4 === 1 mod 3 */, "c"),
		},
		// Tests for PVC names that are edge cases
		{
			Zones:      sets.NewString("a", "b", "c"),
		...
		},
		{
			...
			VolumeName: "henley-",
			NumZones:   2,
			Expected:   sets.NewString("c" /* hash("henley-") = 2652299129 === 2 mod 3 */, "a"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "henley-a",
		...
		},
		{
			...
			VolumeName: "henley-a",
			NumZones:   2,
			Expected:   sets.NewString("c" /* hash("henley-a") = 1459735322 === 2 mod 3 */, "a"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "medium--1",
		...
		},
		{
			...
			VolumeName: "medium--1",
			NumZones:   2,
			Expected:   sets.NewString("c" /* hash("") + 1 == 2166136261 + 1 === 2 mod 3 */, "a"),
		},
		// Tests for PVC names for simple StatefulSet cases
		{
			Zones:      sets.NewString("a", "b", "c"),
		...
		},
		{
			...
			VolumeName: "medium-henley--2",
			NumZones:   2,
			Expected:   sets.NewString("a" /* hash("") + 2 == 0 mod 3 */, "b"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "medium-henley--3",
		...
		},
		{
			...
			VolumeName: "medium-henley--3",
			NumZones:   2,
			Expected:   sets.NewString("b" /* hash("") + 3 == 1 mod 3 */, "c"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "medium-henley--4",
		...
		},
		{
			...
			VolumeName: "medium-henley--4",
			NumZones:   2,
			Expected:   sets.NewString("c" /* hash("") + 4 == 2 mod 3 */, "a"),
		},
		{
			Zones:      sets.NewString("a", "b", "c"),
			VolumeName: "medium-henley--4",
		...
		},
		{
			...
			VolumeName: "medium-henley--4",
			NumZones:   4,
			Expected:   sets.NewString("c" /* hash("") + 4 == 2 mod 3 */, "a", "b", "c"),
		},
	}
