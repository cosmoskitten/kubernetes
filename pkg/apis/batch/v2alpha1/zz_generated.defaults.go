...
func SetObjectDefaults_CronJob(in *v2alpha1.CronJob) {
	...
	for i := range in.Spec.JobTemplate.Spec.Template.Spec.DeferContainers {
		a := &in.Spec.JobTemplate.Spec.Template.Spec.DeferContainers[i]
		v1.SetDefaults_Container(a)
		for j := range a.Ports {
			b := &a.Ports[j]
			v1.SetDefaults_ContainerPort(b)
...
func SetObjectDefaults_JobTemplate(in *v2alpha1.JobTemplate) {
	...
	for i := range in.Template.Spec.Template.Spec.DeferContainers {
		a := &in.Template.Spec.Template.Spec.DeferContainers[i]
		v1.SetDefaults_Container(a)
		for j := range a.Ports {
			b := &a.Ports[j]
			v1.SetDefaults_ContainerPort(b)
