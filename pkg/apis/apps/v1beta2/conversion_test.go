...
func TestV1beta2StatefulSetSpecConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.stsSpec1, internal1, nil); err != nil {
		...
		if err := globalscheme.Scheme.Convert(tc.stsSepc2, internal2, nil); err != nil {
...
func TestV1beta2StatefulSetUpdateStrategyConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.stsUpdateStrategy1, internal1, nil); err != nil {
		...
		if err := globalscheme.Scheme.Convert(tc.stsUpdateStrategy2, internal2, nil); err != nil {
...
func TestV1beta2RollingUpdateDaemonSetConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.rollingUpdateDs1, internal1, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "from extensions to v1beta2", err)
		}
		...
		if err := globalscheme.Scheme.Convert(tc.rollingUpdateDs2, internal2, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "from v1beta2 to extensions", err)
		}
...
func TestV1beta2StatefulSetStatusConversion(t *testing.T) {
	...
	*collisionCount = 1
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.stsStatus1, internal1, nil); err != nil {
		...
		if err := globalscheme.Scheme.Convert(tc.stsStatus2, internal2, nil); err != nil {
...
func TestV1beta2DeploymentConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.deployment1, internal1, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "from extensions to v1beta2", err)
		}
		...
		if err := globalscheme.Scheme.Convert(tc.deployment2, internal2, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "from v1beta2 to extensions", err)
		}
...
func TestV1beta2ScaleStatusConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.scaleStatus1, internal1, nil); err != nil {
		...
		if err := globalscheme.Scheme.Convert(tc.scaleStatus2, internal2, nil); err != nil {
...
func TestV1beta2DeploymentSpecConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.deploymentSpec1, internal, nil); err != nil {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.deploymentSpec2, internal, nil); err != nil {
...
func TestV1beta2DeploymentStrategyConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.deploymentStrategy1, internal1, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "extensions -> v1beta2", err)
		}
		...
		if err := globalscheme.Scheme.Convert(tc.deploymentStrategy2, internal2, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "v1beta2 -> extensions", err)
		}
...
func TestV1beta2RollingUpdateDeploymentConversion(t *testing.T) {
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.rollingUpdateDeployment1, internal1, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "extensions -> v1beta2", err)
		}
		...
		if err := globalscheme.Scheme.Convert(tc.rollingUpdateDeployment2, internal2, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "v1beta2 -> extensions", err)
		}
...
func TestV1beta2ReplicaSetSpecConversion(t *testing.T) {
	...
	*replicas = 2
	...
	for k, tc := range testcases {
		...
		if err := globalscheme.Scheme.Convert(tc.replicaset1, internal1, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "extensions -> v1beta2", err)
		}
		...
		if err := globalscheme.Scheme.Convert(tc.replicaset2, internal2, nil); err != nil {
			t.Errorf("%q - %q: unexpected error: %v", k, "v1beta2 -> extensions", err)
		}
