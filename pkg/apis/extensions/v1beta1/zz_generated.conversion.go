...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_RunAsGroupStrategyOptions_To_extensions_RunAsGroupStrategyOptions,
		Convert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions,
...
func autoConvert_extensions_PodSecurityPolicySpec_To_v1beta1_PodSecurityPolicySpec(in *extensions.PodSecurityPolicySpec, out *v1beta1.PodSecurityPolicySpec, s conversion.Scope) error {
	...
	if err := Convert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions(&in.RunAsGroup, &out.RunAsGroup, s); err != nil {
		return err
	}
...
func autoConvert_v1beta1_RunAsGroupStrategyOptions_To_extensions_RunAsGroupStrategyOptions(in *v1beta1.RunAsGroupStrategyOptions, out *extensions.RunAsGroupStrategyOptions, s conversion.Scope) error {
	out.Rule = extensions.RunAsGroupStrategy(in.Rule)
	out.Ranges = *(*[]extensions.GroupIDRange)(unsafe.Pointer(&in.Ranges))
	return nil
}

// Convert_v1beta1_RunAsGroupStrategyOptions_To_extensions_RunAsGroupStrategyOptions is an autogenerated conversion function.
func Convert_v1beta1_RunAsGroupStrategyOptions_To_extensions_RunAsGroupStrategyOptions(in *v1beta1.RunAsGroupStrategyOptions, out *extensions.RunAsGroupStrategyOptions, s conversion.Scope) error {
	return autoConvert_v1beta1_RunAsGroupStrategyOptions_To_extensions_RunAsGroupStrategyOptions(in, out, s)
}

func autoConvert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions(in *extensions.RunAsGroupStrategyOptions, out *v1beta1.RunAsGroupStrategyOptions, s conversion.Scope) error {
	out.Rule = v1beta1.RunAsGroupStrategy(in.Rule)
	out.Ranges = *(*[]v1beta1.IDRange)(unsafe.Pointer(&in.Ranges))
	return nil
}

// Convert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions is an autogenerated conversion function.
func Convert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions(in *extensions.RunAsGroupStrategyOptions, out *v1beta1.RunAsGroupStrategyOptions, s conversion.Scope) error {
	return autoConvert_extensions_RunAsGroupStrategyOptions_To_v1beta1_RunAsGroupStrategyOptions(in, out, s)
}
