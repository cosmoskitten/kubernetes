...
func (x *PodSecurityPolicySpec) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[15] = x.DefaultAllowPrivilegeEscalation != nil
			yyq2[16] = x.AllowPrivilegeEscalation != false
			var yynn2 int
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[15] {
					if x.DefaultAllowPrivilegeEscalation == nil {
						...
						yy57 := *x.DefaultAllowPrivilegeEscalation
						yym58 := z.EncBinary()
						_ = yym58
						if false {
						} else {
				...
				if yyq2[15] {
					...
					if x.DefaultAllowPrivilegeEscalation == nil {
						...
						yy59 := *x.DefaultAllowPrivilegeEscalation
						yym60 := z.EncBinary()
						_ = yym60
						if false {
						} else {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "allowPrivilegeEscalation":
			if r.TryDecodeAsNil() {
				...
				yyv32 := &x.AllowPrivilegeEscalation
				yym33 := z.DecBinary()
				_ = yym33
				if false {
				} else {
...
func (x *PodSecurityPolicySpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv63 := &x.AllowPrivilegeEscalation
		yym64 := z.DecBinary()
		_ = yym64
		if false {
		} else {
