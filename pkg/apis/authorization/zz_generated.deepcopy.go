...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_authorization_NonResourceRule, InType: reflect.TypeOf(&NonResourceRule{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_authorization_ResourceAttributes, InType: reflect.TypeOf(&ResourceAttributes{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_authorization_ResourceRule, InType: reflect.TypeOf(&ResourceRule{})},
...
// DeepCopy_authorization_NonResourceRule is an autogenerated deepcopy function.
func DeepCopy_authorization_NonResourceRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
// DeepCopy_authorization_ResourceRule is an autogenerated deepcopy function.
func DeepCopy_authorization_ResourceRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceRule)
		...
		*out = *in
		if in.ResourceRules != nil {
			...
			*out = make([]ResourceRule, len(*in))
			for i := range *in {
				if err := DeepCopy_authorization_ResourceRule(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		if in.NonResourceRules != nil {
			...
			*out = make([]NonResourceRule, len(*in))
			for i := range *in {
				if err := DeepCopy_authorization_NonResourceRule(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
