...
func (lbaas *LbaasV2) ListServiceByLoadBalancer(clusterName string) (serviceToLoadbalancer map[string]*v1.LoadBalancerStatus, err error) {
...
// ListServiceByLoadBalancer list services whose load balancer are created by kubernetes.
// The key of the map contains service's namespace and service's name, like: namespace/name
func (lb *LbaasV1) ListServiceByLoadBalancer(clusterName string) (serviceToLoadbalancer map[string]*v1.LoadBalancerStatus, err error) {
