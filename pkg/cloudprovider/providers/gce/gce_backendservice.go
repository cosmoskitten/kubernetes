...
func (gce *GCECloud) GetGlobalBackendService(name string) (*compute.BackendService, error) {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Get(%s, %s): start", gce.projectID, name)
	v, err := gce.service.BackendServices.Get(gce.projectID, name).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Get(%s, %s): end", gce.projectID, name)
...
func (gce *GCECloud) UpdateGlobalBackendService(bg *compute.BackendService) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Update(%s, %s, %v): start", gce.projectID, bg.Name, bg)
	op, err := gce.service.BackendServices.Update(gce.projectID, bg.Name, bg).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Update(%s, %s, %v): end", gce.projectID, bg.Name, bg)
	if err != nil {
...
func (gce *GCECloud) DeleteGlobalBackendService(name string) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Delete(%s, %s): start", gce.projectID, name)
	op, err := gce.service.BackendServices.Delete(gce.projectID, name).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Delete(%s, %s): end", gce.projectID, name)
	if err != nil {
...
func (gce *GCECloud) CreateGlobalBackendService(bg *compute.BackendService) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Insert(%s, %v): start", gce.projectID, bg)
	op, err := gce.service.BackendServices.Insert(gce.projectID, bg).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.Insert(%s, %v): end", gce.projectID, bg)
	if err != nil {
		return mc.Observe(err)
	}
...
func (gce *GCECloud) ListGlobalBackendServices() (*compute.BackendServiceList, error) {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.List(%s): start", gce.projectID)
	v, err := gce.service.BackendServices.List(gce.projectID).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.List(%s): end", gce.projectID)
	return v, mc.Observe(err)
}
...
func (gce *GCECloud) GetGlobalBackendServiceHealth(name string, instanceGroupLink string) (*compute.BackendServiceGroupHealth, error) {
	...
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.GetHealth(%s, %s, %v): start", gce.projectID, name, groupRef)
	v, err := gce.service.BackendServices.GetHealth(gce.projectID, name, groupRef).Do()
	glog.V(cloudprovider.APILogLevel).Infof("BackendServices.GetHealth(%s, %s, %v): end", gce.projectID, name, groupRef)
	return v, mc.Observe(err)
}
...
func (gce *GCECloud) GetRegionBackendService(name, region string) (*compute.BackendService, error) {
	...
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Get(%s, %s, %s): start", gce.projectID, region, name)
	v, err := gce.service.RegionBackendServices.Get(gce.projectID, region, name).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Get(%s, %s, %s): end", gce.projectID, region, name)
	return v, mc.Observe(err)
}
...
func (gce *GCECloud) UpdateRegionBackendService(bg *compute.BackendService, region string) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Update(%s, %s, %v): start", gce.projectID, region, bg.Name)
	op, err := gce.service.RegionBackendServices.Update(gce.projectID, region, bg.Name, bg).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Update(%s, %s, %v): end", gce.projectID, region, bg.Name)
	if err != nil {
		return mc.Observe(err)
	}
...
func (gce *GCECloud) DeleteRegionBackendService(name, region string) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Delete(%s, %s, %s): start", gce.projectID, region, name)
	op, err := gce.service.RegionBackendServices.Delete(gce.projectID, region, name).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Delete(%s, %s, %s): end", gce.projectID, region, name)
	if err != nil {
		if isHTTPErrorCode(err, http.StatusNotFound) {
			return nil
		}
...
func (gce *GCECloud) CreateRegionBackendService(bg *compute.BackendService, region string) error {
	...
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Insert(%s, %s, %v): start", gce.projectID, region, bg)
	op, err := gce.service.RegionBackendServices.Insert(gce.projectID, region, bg).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.Insert(%s, %s, %v): end", gce.projectID, region, bg)
	if err != nil {
		return mc.Observe(err)
	}
...
func (gce *GCECloud) ListRegionBackendServices(region string) (*compute.BackendServiceList, error) {
	...
	// TODO: use PageToken to list all not just the first 500
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.List(%s, %s): start", gce.projectID, region)
	v, err := gce.service.RegionBackendServices.List(gce.projectID, region).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.List(%s, %s): end", gce.projectID, region)
	return v, mc.Observe(err)
}
...
func (gce *GCECloud) GetRegionalBackendServiceHealth(name, region string, instanceGroupLink string) (*compute.BackendServiceGroupHealth, error) {
	...
	groupRef := &compute.ResourceGroupReference{Group: instanceGroupLink}
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.GetHealth(%s, %s, %s, %v): start", gce.projectID, region, name, groupRef)
	v, err := gce.service.RegionBackendServices.GetHealth(gce.projectID, region, name, groupRef).Do()
	glog.V(cloudprovider.APILogLevel).Infof("RegionBackendServices.GetHealth(%s, %s, %s, %v): end", gce.projectID, region, name, groupRef)
	return v, mc.Observe(err)
}
