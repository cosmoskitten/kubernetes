...
func makeNodesHealthCheckName(clusterId string) string {
	return fmt.Sprintf("k8s-%v-nodes-healthcheck", clusterId)
}
...
func makeNodesHealthCheckFirewallNameSuffix(clusterId string) string {
	return fmt.Sprintf("%v-nodes-healthcheck", clusterId)
}
