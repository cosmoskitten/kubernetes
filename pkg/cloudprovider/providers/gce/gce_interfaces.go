...
type CloudAddressService interface {
	ReserveRegionAddress(*computev1.Address, string) error
	GetRegionAddress(string, string) (*computev1.Address, error)
	GetRegionAddressByIP(region, ipAddress string) (*computev1.Address, error)
