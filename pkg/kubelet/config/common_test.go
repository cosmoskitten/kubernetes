...
func TestDecodeSinglePod(t *testing.T) {
	...
	for _, gv := range globalscheme.Registry.EnabledVersionsForGroup(v1.GroupName) {
		info, _ := runtime.SerializerInfoForMediaType(globalscheme.Codecs.SupportedMediaTypes(), "application/yaml")
		encoder := globalscheme.Codecs.EncoderForVersion(info.Serializer, gv)
