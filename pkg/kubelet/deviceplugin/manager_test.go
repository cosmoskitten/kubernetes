...
func setup(t *testing.T, devs []*pluginapi.Device, pluginSocket, serverSocket string, callback MonitorCallback) (Manager, *DevicePluginStub) {
...
func cleanup(t *testing.T, m Manager, p *DevicePluginStub) {
	p.Stop()
	m.Stop()
}
