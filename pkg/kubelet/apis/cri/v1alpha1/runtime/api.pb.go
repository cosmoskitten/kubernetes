...
type LinuxSandboxSecurityContext struct {
	...
	SupplementalGroups []int64 `protobuf:"varint,6,rep,packed,name=supplemental_groups,json=supplementalGroups" json:"supplemental_groups,omitempty"`
	...
	SeccompProfilePath string `protobuf:"bytes,8,opt,name=seccomp_profile_path,json=seccompProfilePath,proto3" json:"seccomp_profile_path,omitempty"`
}
...
type LinuxContainerSecurityContext struct {
	...
	RunAsGroup *Int64Value `protobuf:"bytes,6,opt,name=run_as_group,json=runAsGroup" json:"run_as_group,omitempty"`
	// User name to run the container process as. If specified, the user MUST
	// exist in the container image (i.e. in the /etc/passwd inside the image),
	// and be resolved there by the runtime; otherwise, the runtime MUST error.
	RunAsUsername string `protobuf:"bytes,7,opt,name=run_as_username,json=runAsUsername,proto3" json:"run_as_username,omitempty"`
	// Group name to run the container process as. If specified, the group MUST
	// exist in the container image (i.e. in the /etc/group inside the image),
	// and be resolved there by the runtime; otherwise, the runtime MUST error.
	RunAsGroupname string `protobuf:"bytes,8,opt,name=run_as_groupname,json=runAsGroupname,proto3" json:"run_as_groupname,omitempty"`
	// If set, the root filesystem of the container is read-only.
	ReadonlyRootfs bool `protobuf:"varint,9,opt,name=readonly_rootfs,json=readonlyRootfs,proto3" json:"readonly_rootfs,omitempty"`
	// List of groups applied to the first process run in the container, in
	// addition to the container's primary GID.
	SupplementalGroups []int64 `protobuf:"varint,10,rep,packed,name=supplemental_groups,json=supplementalGroups" json:"supplemental_groups,omitempty"`
	// AppArmor profile for the container, candidate values are:
	// * runtime/default: equivalent to not specifying a profile.
	// * localhost/<profile_name>: profile loaded on the node
	//    (localhost) by name. The possible profile names are detailed at
	//    http://wiki.apparmor.net/index.php/AppArmor_Core_Policy_Reference
	ApparmorProfile string `protobuf:"bytes,11,opt,name=apparmor_profile,json=apparmorProfile,proto3" json:"apparmor_profile,omitempty"`
	...
	//   <full-path-to-profile> is the full path of the profile.
	// Default: "", which is identical with unconfined.
	SeccompProfilePath string `protobuf:"bytes,12,opt,name=seccomp_profile_path,json=seccompProfilePath,proto3" json:"seccomp_profile_path,omitempty"`
	// no_new_privs defines if the flag for no_new_privs should be set on the
	// container.
	NoNewPrivs bool `protobuf:"varint,13,opt,name=no_new_privs,json=noNewPrivs,proto3" json:"no_new_privs,omitempty"`
}
...
func (m *LinuxContainerSecurityContext) GetRunAsGroupname() string {
	if m != nil {
		return m.RunAsGroupname
	}
	return ""
}
...
func (m *LinuxSandboxSecurityContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RunAsGroup != nil {
		...
		n4, err := m.RunAsGroup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *LinuxContainerSecurityContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RunAsGroup != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.RunAsGroup.Size()))
		n25, err := m.RunAsGroup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if len(m.RunAsGroupname) > 0 {
		dAtA[i] = 0x42
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.RunAsGroupname)))
		i += copy(dAtA[i:], m.RunAsGroupname)
	}
	if m.ReadonlyRootfs {
		dAtA[i] = 0x48
		i++
...
func (m *ContainerConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Linux != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Linux.Size()))
		n32, err := m.Linux.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (this *LinuxContainerSecurityContext) String() string {
	...
	s := strings.Join([]string{`&LinuxContainerSecurityContext{`,
		...
		`RunAsGroupname:` + fmt.Sprintf("%v", this.RunAsGroupname) + `,`,
		`ReadonlyRootfs:` + fmt.Sprintf("%v", this.ReadonlyRootfs) + `,`,
		`SupplementalGroups:` + fmt.Sprintf("%v", this.SupplementalGroups) + `,`,
...
func (m *LinuxContainerSecurityContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RunAsGroupname", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RunAsGroupname = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadonlyRootfs", wireType)
...
var fileDescriptorApi = []byte{
	...
	,
}
