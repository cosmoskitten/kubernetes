...
func (cm *containerManagerStub) Start(_ *v1.Node, _ cmtypes.ActivePodsFunc, _ status.PodStatusProvider, _ internalapi.RuntimeService) error {
...
func (cm *containerManagerStub) GetNodeConfig() cmtypes.NodeConfig {
	return cmtypes.NodeConfig{}
}

func (cm *containerManagerStub) GetMountedSubsystems() *cmtypes.CgroupSubsystems {
	return &CgroupSubsystems{}
}

func (cm *containerManagerStub) GetQOSContainersInfo() cmtypes.QOSContainersInfo {
...
func (cm *containerManagerStub) NewPodContainerManager() cmtypes.PodContainerManager {
