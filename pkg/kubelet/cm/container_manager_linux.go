...
type containerManagerImpl struct {
	...
	devicePluginHandler *DevicePluginHandlerImpl
}
...
func NewContainerManager(mountUtil mount.Interface, cadvisorInterface cadvisor.Interface, nodeConfig NodeConfig, failSwapOn bool, devicePluginEnabled bool, recorder record.EventRecorder) (ContainerManager, error) {
	...
	devicePluginHandler, err := NewDevicePluginHandler(devicePluginEnabled, updateDeviceCapacityFunc)
	if err != nil {
		return nil, err
	}
	// Starts device plugin manager.
	if err := devicePluginHandler.Start(); err != nil {
                 return nil, err
        }
	cm.devicePluginHandler = devicePluginHandler
