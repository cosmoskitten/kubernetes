...
type Manager interface {
	...
	Start(activePods cmtypes.ActivePodsFunc, podStatusProvider status.PodStatusProvider, containerRuntime runtimeService)
...
func (m *manager) Start(activePods cmtypes.ActivePodsFunc, podStatusProvider status.PodStatusProvider, containerRuntime runtimeService) {
