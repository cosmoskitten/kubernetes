...
func TestValidateVolumeDevices(t *testing.T) {
	...
	validPath1 := "/foo"
	validPath2 := "/usr/share/test"
	validName1 := "abc"
	validName2 := "abc-123"
	invalidName := "not-found"
	relativePath := "baz"
	emptyString := ""

	successCase := []*api.VolumeDevice{
		{Name: &validName1, DevicePath: &validPath1},
		{Name: &validName2, DevicePath: &validPath2},
	}
	...
	errorCases := map[string][]*api.VolumeDevice{
		"empty name":           {{Name: &emptyString, DevicePath: &validPath1}},
		"name not found":       {{Name: &invalidName, DevicePath: &validPath2}},
		"empty devicepath":     {{Name: &validName1, DevicePath: &emptyString}},
		"relative devicepath":  {{Name: &validName2, DevicePath: &relativePath}},
		"duplicate devicepath": {{Name: &validName1, DevicePath: &validPath1},{Name: &validName2, DevicePath: &validPath1}},
	}
	for k, v := range errorCases {
