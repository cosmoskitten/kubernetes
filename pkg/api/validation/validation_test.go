...
func TestAlphaPVCVolumeMode(t *testing.T) {
	...
	successCasesPVC := map[string]*api.PersistentVolumeClaim {
		"valid block value":      CreateTestVolModePVC(api.PersistentVolumeBlock),
		"valid filesystem value": CreateTestVolModePVC(api.PersistentVolumeFilesystem),
	}
	...
	errorCasesPVC := map[string]*api.PersistentVolumeClaim {
		"invalid value": CreateTestVolModePVC(api.PersistentVolumeMode("fake")),
		"empty value":   CreateTestVolModePVC(api.PersistentVolumeMode("")),
	}
...
func TestAlphaPVVolumeMode(t *testing.T) {
	...
	successCasesPV := map[string]*api.PersistentVolume {
		"valid block value":      CreateTestVolModePV(api.PersistentVolumeBlock),
		"valid filesystem value": CreateTestVolModePV(api.PersistentVolumeFilesystem),
	}
	...
	errorCasesPV := map[string]*api.PersistentVolume {
		"invalid value": CreateTestVolModePV(api.PersistentVolumeMode("fake")),
		"empty value":   CreateTestVolModePV(api.PersistentVolumeMode("")),
	}
