...
func TestValidateService(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.AnnotationLoadBalancerSourceRangesKey] = "1.2.3.4/8,  5.6.7.8/16"
			},
			numErrs: 0,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.AnnotationLoadBalancerSourceRangesKey] = ""
			},
			numErrs: 0,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Annotations[annotations.AnnotationLoadBalancerSourceRangesKey] = "foo.bar"
			},
			numErrs: 2,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.AnnotationLoadBalancerSourceRangesKey] = "1.2.3.4/33"
			},
			numErrs: 1,
		},
		{
		...
		// ESIPP section begins.
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
			},
			numErrs: 0,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.BetaAnnotationExternalTraffic] = "invalid"
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
				s.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "-1"
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
				s.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "whatisthis"
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
				s.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "31100"
			},
			numErrs: 0,
		},
		{
		...
		},
		{
			...
			tweakSvc: func(s *api.Service) {
				s.Spec.Type = api.ServiceTypeLoadBalancer
				s.Spec.ExternalTrafficPolicy = api.ServiceExternalTrafficPolicyTypeLocal
				s.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "3001"
			},
			numErrs: 1,
		},
		// ESIPP section ends.
...
func TestValidateServiceUpdate(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *api.Service) {
				oldSvc.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficLocal
				oldSvc.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "3001"
			},
			numErrs: 0,
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *api.Service) {
				...
				oldSvc.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = "3001"
				newSvc.Spec.Type = api.ServiceTypeLoadBalancer
				newSvc.Annotations[annotations.BetaAnnotationExternalTraffic] = annotations.AnnotationValueExternalTrafficGlobal
				newSvc.Annotations[annotations.BetaAnnotationHealthCheckNodePort] = oldSvc.Annotations[annotations.BetaAnnotationHealthCheckNodePort]
			},
			numErrs: 0,
		},
		{
