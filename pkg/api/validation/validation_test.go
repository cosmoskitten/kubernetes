...
func TestValidateResourceQuotaWithAlphaLocalStorageCapacityIsolation(t *testing.T) {
	spec := api.ResourceQuotaSpec{
		Hard: api.ResourceList{
			...
			api.ResourceStorageScratch:         resource.MustParse("10000"),
			api.ResourceRequestsStorageScratch: resource.MustParse("10000"),
			api.ResourceLimitsStorageScratch:   resource.MustParse("10000"),
		},
	}
	...
	expectedErrMes := "ResourceStorageScratch field disabled by feature-gate for ResourceQuota"
	for i := range errs {
