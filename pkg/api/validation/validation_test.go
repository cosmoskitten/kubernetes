...
func TestValidateOrSetClientIPAffinityConfig(t *testing.T) {
	successCases := map[string]*api.SessionAffinityConfig{
		...
		"empty client IP config": &api.SessionAffinityConfig{
			ClientIP: nil,
		},
		"non-empty config, valid timeout: 1": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: 1,
			},
		},
		"non-empty config, valid timeout: api.DefaultClientIPServiceAffinitySeconds": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: api.DefaultClientIPServiceAffinitySeconds,
			},
		},
		"non-empty config, valid timeout: api.MaxClientIPServiceAffinitySeconds-1": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: api.MaxClientIPServiceAffinitySeconds-1,
			},
		},
		"non-empty config, valid timeout: api.MaxClientIPServiceAffinitySeconds": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
	...
	errorCases := map[string]*api.SessionAffinityConfig{
		"non-empty config, invalid timeout: api.MaxClientIPServiceAffinitySeconds+1": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: api.MaxClientIPServiceAffinitySeconds+1,
			},
		},
		"non-empty config, invalid timeout: -1": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: -1,
			},
		},
		"non-empty config, invalid timeout: 0": &api.SessionAffinityConfig{
			ClientIP: &api.ClientIPConfig{
				TimeoutSeconds: 0,
			},
		},
