...
func TestAlphaValidateVolumeDevices(t *testing.T) {
	volumes := []api.Volume{
		...
		{Name: "def", VolumeSource: api.VolumeSource{HostPath: &api.HostPathVolumeSource{Path: "/foo/baz"}}},
	}
	...
	errorCases := map[string][]api.VolumeDevice{
		...
		"invalid source":       {{Name: "def", DevicePath: "/usr/share/test"}},
