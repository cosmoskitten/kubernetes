...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_EventAction_To_api_EventAction,
		Convert_api_EventAction_To_v1_EventAction,
		Convert_v1_EventList_To_api_EventList,
		Convert_api_EventList_To_v1_EventList,
		Convert_v1_EventSeries_To_api_EventSeries,
		Convert_api_EventSeries_To_v1_EventSeries,
...
func autoConvert_v1_Event_To_api_Event(in *v1.Event, out *api.Event, s conversion.Scope) error {
	...
	if err := Convert_v1_EventSource_To_api_EventSource(&in.Origin, &out.Origin, s); err != nil {
		return err
	}
	if err := Convert_v1_EventAction_To_api_EventAction(&in.Action, &out.Action, s); err != nil {
		return err
	}
...
func autoConvert_api_Event_To_v1_Event(in *api.Event, out *v1.Event, s conversion.Scope) error {
	...
	if err := Convert_api_EventSource_To_v1_EventSource(&in.Origin, &out.Origin, s); err != nil {
		return err
	}
	if err := Convert_api_EventAction_To_v1_EventAction(&in.Action, &out.Action, s); err != nil {
		return err
	}
	...
	out.Severity = v1.EventSeverity(in.Severity)
	return nil
}
...
func autoConvert_v1_EventAction_To_api_EventAction(in *v1.EventAction, out *api.EventAction, s conversion.Scope) error {
	out.Action = in.Action
	out.Reason = in.Reason
	return nil
}

// Convert_v1_EventAction_To_api_EventAction is an autogenerated conversion function.
func Convert_v1_EventAction_To_api_EventAction(in *v1.EventAction, out *api.EventAction, s conversion.Scope) error {
	return autoConvert_v1_EventAction_To_api_EventAction(in, out, s)
}

func autoConvert_api_EventAction_To_v1_EventAction(in *api.EventAction, out *v1.EventAction, s conversion.Scope) error {
	out.Action = in.Action
	out.Reason = in.Reason
	return nil
}

// Convert_api_EventAction_To_v1_EventAction is an autogenerated conversion function.
func Convert_api_EventAction_To_v1_EventAction(in *api.EventAction, out *v1.EventAction, s conversion.Scope) error {
	return autoConvert_api_EventAction_To_v1_EventAction(in, out, s)
}
...
func autoConvert_v1_EventSeries_To_api_EventSeries(in *v1.EventSeries, out *api.EventSeries, s conversion.Scope) error {
	out.UID = in.UID
	out.Count = in.Count
...
// Convert_v1_EventSeries_To_api_EventSeries is an autogenerated conversion function.
func Convert_v1_EventSeries_To_api_EventSeries(in *v1.EventSeries, out *api.EventSeries, s conversion.Scope) error {
	return autoConvert_v1_EventSeries_To_api_EventSeries(in, out, s)
}

func autoConvert_api_EventSeries_To_v1_EventSeries(in *api.EventSeries, out *v1.EventSeries, s conversion.Scope) error {
	out.UID = in.UID
	out.Count = in.Count
	out.HeartbeatTime = in.HeartbeatTime
	out.LastObservedTime = in.LastObservedTime
...
// Convert_api_EventSeries_To_v1_EventSeries is an autogenerated conversion function.
func Convert_api_EventSeries_To_v1_EventSeries(in *api.EventSeries, out *v1.EventSeries, s conversion.Scope) error {
	return autoConvert_api_EventSeries_To_v1_EventSeries(in, out, s)
}
