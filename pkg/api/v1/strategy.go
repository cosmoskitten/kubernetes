...
func PodToSelectableFields(pod *api.Pod) fields.Set {
	...
	podSpecificFieldsSet["metadata.uid"] = string(pod.ObjectMeta.UID)
	podSpecificFieldsSet["spec.nodeName"] = string(pod.Spec.NodeName)
	podSpecificFieldsSet["spec.restartPolicy"] = string(pod.Spec.RestartPolicy)
	podSpecificFieldsSet["status.phase"] = string(pod.Status.Phase)
	podSpecificFieldsSet["status.podIP"] = string(pod.Status.PodIP)
	podSpecificFieldsSet["status.hostIP"] = string(pod.Status.HostIP)
