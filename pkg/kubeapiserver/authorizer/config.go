...
// New returns the right sort of union of multiple authorizer.Authorizer and authorizer.AuthorizationRulesGetter objects
// based on the authorizationMode or an error.
func (config AuthorizationConfig) New() (authorizer.Authorizer, authorizer.AuthorizationRulesGetter, error) {
	...
	for _, authorizationMode := range config.AuthorizationModes {
		...
		case modes.ModeAlwaysAllow:
			...
			authorizationRulesGetter = append(authorizationRulesGetter, alwaysAllowAuthorizer)
		case modes.ModeAlwaysDeny:
			alwaysDenyAuthorizer := authorizerfactory.NewAlwaysDenyAuthorizer()
			authorizers = append(authorizers, alwaysDenyAuthorizer)
			authorizationRulesGetter = append(authorizationRulesGetter, alwaysDenyAuthorizer)
		case modes.ModeABAC:
			...
			authorizationRulesGetter = append(authorizationRulesGetter, abacAuthorizer)
		case modes.ModeWebhook:
			...
			authorizationRulesGetter = append(authorizationRulesGetter, webhookAuthorizer)
		case modes.ModeRBAC:
			...
			authorizationRulesGetter = append(authorizationRulesGetter, rbacAuthorizer)
		default:
	...
	return union.New(authorizers...), union.NewRulesGetter(authorizationRulesGetter...), nil
}
