...
type StatefulSetInterface interface {
	...
	UpdateScale(statefulSetName string, scale *apps.Scale) (*extensions.Scale, error)
...
func (c *statefulSets) UpdateScale(statefulSetName string, scale *apps.Scale) (result *extensions.Scale, err error) {
	result = &extensions.Scale{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("statefulsets").
