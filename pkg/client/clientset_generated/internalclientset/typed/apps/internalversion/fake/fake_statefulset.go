...
// GetScale takes name of the statefulSet, and returns the corresponding statefulSet object, and an error if there is any.
...
func (c *FakeStatefulSets) UpdateScale(statefulSetName string, scale *apps.Scale) (result *extensions.Scale, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(statefulsetsResource, "scale", c.ns, scale), &apps.Scale{})
