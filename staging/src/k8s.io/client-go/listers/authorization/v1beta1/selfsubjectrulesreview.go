...
// List lists all SelfSubjectRulesReviews in the indexer for a given namespace.
func (s selfSubjectRulesReviewNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.SelfSubjectRulesReview, err error) {
...
// Get retrieves the SelfSubjectRulesReview from the indexer for a given namespace and name.
func (s selfSubjectRulesReviewNamespaceLister) Get(name string) (*v1beta1.SelfSubjectRulesReview, error) {
