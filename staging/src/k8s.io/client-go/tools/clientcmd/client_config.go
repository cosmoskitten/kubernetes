...
func (config *DirectClientConfig) Namespace() (string, bool, error) {
	// if an override is provided and it starts with namespaces/ (as generated by `kubectl get ns -o name`), strip it off
	// (this is intentionally targeted towards interactive use only)
	namespace := config.overrides.Context.Namespace
	...
	if config.overrides != nil && namespace != "" {
