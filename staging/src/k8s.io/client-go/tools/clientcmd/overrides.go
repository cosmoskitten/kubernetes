...
func RecommendedConfigOverrideFlags(prefix string) ConfigOverrideFlags {
	return ConfigOverrideFlags{
		...
		IncludeUninitialized: FlagInfo{prefix + FlagIncludeUninitialized, "", "false", "If true, include the object(s) that have not been realized yet. Such object(s) have a non-empty initializer list."},
	}
}
