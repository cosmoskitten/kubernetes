			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF81234, string(x.Next))
					}
				} else {
					r.EncodeString(codecSelferC_UTF81234, "")
				}
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("next"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yym17 := z.EncBinary()
					_ = yym17
					if false {
		...
		case "Items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceNodeMetrics((*[]NodeMetrics)(yyv14), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *NodeMetricsList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceNodeMetrics((*[]NodeMetrics)(yyv27), d)
		}
	}
	for {
		yyj16++
		...
		case "Items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicePodMetrics((*[]PodMetrics)(yyv14), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *PodMetricsList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicePodMetrics((*[]PodMetrics)(yyv27), d)
		}
	}
	for {
		yyj16++
