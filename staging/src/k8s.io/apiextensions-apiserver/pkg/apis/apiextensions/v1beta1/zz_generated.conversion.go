...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer,
		Convert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer,
...
func autoConvert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer(in *JSONSchemaPointer, out *apiextensions.JSONSchemaPointer, s conversion.Scope) error {
	out.ReferenceTokens = *(*[]string)(unsafe.Pointer(&in.ReferenceTokens))
	return nil
}

// Convert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer is an autogenerated conversion function.
func Convert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer(in *JSONSchemaPointer, out *apiextensions.JSONSchemaPointer, s conversion.Scope) error {
	return autoConvert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer(in, out, s)
}

func autoConvert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer(in *apiextensions.JSONSchemaPointer, out *JSONSchemaPointer, s conversion.Scope) error {
	out.ReferenceTokens = *(*[]string)(unsafe.Pointer(&in.ReferenceTokens))
	return nil
}

// Convert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer is an autogenerated conversion function.
func Convert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer(in *apiextensions.JSONSchemaPointer, out *JSONSchemaPointer, s conversion.Scope) error {
	return autoConvert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer(in, out, s)
}
