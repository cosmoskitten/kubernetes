...
func NewStrategy(typer runtime.ObjectTyper, namespaceScoped bool, kind schema.GroupVersionKind, crd *apiextensions.CustomResourceDefinition, validator *validate.SchemaValidator) CustomResourceDefinitionStorageStrategy {
