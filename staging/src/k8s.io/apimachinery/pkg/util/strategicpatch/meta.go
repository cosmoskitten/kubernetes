...
func (s PatchMetaFromOpenAPI) Elem() LookupPatchMeta {
	...
	subschema := arr.SubType
	return PatchMetaFromOpenAPI{Schema: subschema}
}
...
func (s PatchMetaFromStruct) Elem() LookupPatchMeta {
	return PatchMetaFromStruct{T: s.T.Elem()}
}
