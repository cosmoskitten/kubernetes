...
type OIDCOptions struct {
	...
	//
	// If not provided, the authenticator prefixes all username claims other than "email"
	// with the issuer URL.
	//
	//		https://example.com/auth#john
	//
	// The special value "-" can be used to skip all prefixing.
