...
const (
	...
	defaultBatchMaxRoutine      = 10 // Send routine at 10 qps.
	defaultBatchMaxRoutineBurst = 15 // Send routine burst is 15.
)
...
func newBatchWebhook(configFile string, groupVersion schema.GroupVersion) (*batchBackend, error) {
	...
	return &batchBackend{
		...
		throttle:     flowcontrol.NewTokenBucketRateLimiter(defaultBatchMaxRoutine, defaultBatchMaxRoutineBurst),
	}, nil
}
