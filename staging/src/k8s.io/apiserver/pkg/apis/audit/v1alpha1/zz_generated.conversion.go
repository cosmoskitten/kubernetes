...
func autoConvert_audit_GroupResources_To_v1alpha1_GroupResources(in *audit.GroupResources, out *GroupResources, s conversion.Scope) error {
	out.Group = in.Group
	out.Resources = *(*[]string)(unsafe.Pointer(&in.Resources))
	// WARNING: in.ResourceNames requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v1alpha1_Policy_To_audit_Policy(in *Policy, out *audit.Policy, s conversion.Scope) error {
	...
	if in.Rules != nil {
		...
		*out = make([]audit.PolicyRule, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_PolicyRule_To_audit_PolicyRule(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_audit_Policy_To_v1alpha1_Policy(in *audit.Policy, out *Policy, s conversion.Scope) error {
	...
	if in.Rules != nil {
		...
		*out = make([]PolicyRule, len(*in))
		for i := range *in {
			if err := Convert_audit_PolicyRule_To_v1alpha1_PolicyRule(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha1_PolicyRule_To_audit_PolicyRule(in *PolicyRule, out *audit.PolicyRule, s conversion.Scope) error {
	...
	if in.Resources != nil {
		...
		*out = make([]audit.GroupResources, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_GroupResources_To_audit_GroupResources(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_audit_PolicyRule_To_v1alpha1_PolicyRule(in *audit.PolicyRule, out *PolicyRule, s conversion.Scope) error {
	...
	if in.Resources != nil {
		...
		*out = make([]GroupResources, len(*in))
		for i := range *in {
			if err := Convert_audit_GroupResources_To_v1alpha1_GroupResources(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
