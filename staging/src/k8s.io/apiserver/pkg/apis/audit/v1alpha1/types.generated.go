...
func (x *Event) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[1] = x.APIVersion != ""
			yyq2[2] = true
			yyq2[10] = x.ImpersonatedUser != nil
			yyq2[11] = len(x.SourceIPs) != 0
			yyq2[12] = x.ObjectRef != nil
			yyq2[13] = x.ResponseStatus != nil
			yyq2[14] = x.RequestObject != nil
			yyq2[15] = x.ResponseObject != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					if x.OmitStages == nil {
						...
						if false {
							...
							h.encSliceStage(([]Stage)(x.OmitStages), e)
						}
					}
				} else {
					r.EncodeNil()
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("omitStages"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					if x.OmitStages == nil {
						r.EncodeNil()
					} else {
...
func (x *PolicyRule) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceGroupResources((*[]GroupResources)(yyv27), d)
		}
	}
	yyj19++
	if yyhl19 {
...
func (x codecSelfer1234) encSliceStage(v []Stage, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decSliceStage(v *[]Stage, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == 0 {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, "") // var yyz1 Stage
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
