...
func TestChecker(t *testing.T) {
	...
	test("namespaced", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived")}, "omit RequestReceived", "getPods", "default")
	test("namespaced", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived"), audit.Stage("ResponseStarted"), audit.Stage("ResponseComplete")}, "only audit painc", "getPods", "default")
	...
	test("cluster", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived")}, "omit RequestReceived", "getPods", "default")
	test("cluster", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived"), audit.Stage("ResponseStarted"), audit.Stage("ResponseComplete")}, "only audit painc", "getPods", "default")
	...
	test("nonResource", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived")}, "omit RequestReceived", "getPods", "default")
	test("nonResource", audit.LevelRequest, []audit.Stage{audit.Stage("RequestReceived"), audit.Stage("ResponseStarted"), audit.Stage("ResponseComplete")}, "only audit painc", "getPods", "default")
}
