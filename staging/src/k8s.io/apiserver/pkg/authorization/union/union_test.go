...
func (mock *mockAuthzRuleHandler) RulesFor(user user.Info, namespace string) ([]authorizer.ResourceRuleInfo, []authorizer.NonResourceRuleInfo, error) {
	if mock.err != nil {
		return []authorizer.ResourceRuleInfo{}, []authorizer.NonResourceRuleInfo{}, mock.err
	}
	return mock.resourceRules, mock.nonResourceRules, nil
}
...
func TestAuthorizationResourceRules(t *testing.T) {
	...
	rules, _, _ := authzRulesHandler.RulesFor(nil, "")
...
func TestAuthorizationNonResourceRules(t *testing.T) {
	...
	_, rules, _ := authzRulesHandler.RulesFor(nil, "")
