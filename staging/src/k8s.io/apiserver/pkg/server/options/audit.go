...
func NewAuditOptions() *AuditOptions {
	return &AuditOptions{
		...
		LogOptions:     AuditLogOptions{Format: pluginlog.FormatJson, Mode: pluginlog.ModeBuffer},
	}
}
...
func (o *AuditLogOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&o.Mode, "audit-log-mode", o.Mode,
		"Strategy for sending audit events. Buffer indicates events firstly enqueue,"+
			" and events are asynchronously processed by several goroutines. Direct indicates"+
