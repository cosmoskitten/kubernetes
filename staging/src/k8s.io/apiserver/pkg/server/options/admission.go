...
func (a *AdmissionOptions) ApplyTo(serverCfg *server.Config, pluginInitializers ...admission.PluginInitializer) error {
	if len(a.PluginNames) < 0 {
		a.PluginNames = a.getEnabledPluginNames()
	}
...
// getEnabledPluginNames makes use of RecommendedPluginOrder and DefaultOffPlugins fields
// to prepare a list of plugin names that are enabled.
func (a *AdmissionOptions) getEnabledPluginNames() []string {
