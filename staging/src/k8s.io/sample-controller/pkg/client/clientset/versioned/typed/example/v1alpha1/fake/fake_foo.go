...
var foosResource = schema.GroupVersionResource{Group: "example.controller.code-generator.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "example.controller.code-generator.k8s.io", Version: "v1alpha1", Kind: "Foo"}
