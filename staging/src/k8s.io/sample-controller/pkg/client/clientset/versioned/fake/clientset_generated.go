...
import (
	...
	examplev1alpha1 "k8s.io/sample-controller/pkg/client/clientset/versioned/typed/example/v1alpha1"
	fakeexamplev1alpha1 "k8s.io/sample-controller/pkg/client/clientset/versioned/typed/example/v1alpha1/fake"
)
