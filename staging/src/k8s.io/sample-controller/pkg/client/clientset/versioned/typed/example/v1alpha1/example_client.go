...
// ExampleV1alpha1Client is used to interact with features provided by the example.controller.code-generator.k8s.io group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) NGINXs(namespace string) NGINXInterface {
	return newNGINXs(c, namespace)
}
