...
func (x *CronJobSpec) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			_, _, _ = yysep2, yyq2, yy2arr2
			const yyr2 bool = false
			yyq2[2] = x.StartingDeadlineSeconds != nil
			yyq2[3] = x.ConcurrencyPolicy != ""
			yyq2[4] = x.Suspend != nil
			yyq2[6] = x.SuccessfulJobsHistoryLimit != nil
			yyq2[7] = x.FailedJobsHistoryLimit != nil
			var yynn2 int
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF81234, string(x.TimeZone))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("timeZone"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if x.StartingDeadlineSeconds == nil {
						...
						yy10 := *x.StartingDeadlineSeconds
						yym11 := z.EncBinary()
						_ = yym11
						if false {
						} else {
				...
				if yyq2[2] {
					...
					if x.StartingDeadlineSeconds == nil {
						...
						yy12 := *x.StartingDeadlineSeconds
						yym13 := z.EncBinary()
						_ = yym13
						if false {
						} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					if x.SuccessfulJobsHistoryLimit == nil {
						...
						yy28 := *x.SuccessfulJobsHistoryLimit
						yym29 := z.EncBinary()
						_ = yym29
						if false {
						} else {
				...
				if yyq2[6] {
					...
					if x.SuccessfulJobsHistoryLimit == nil {
						...
						yy30 := *x.SuccessfulJobsHistoryLimit
						yym31 := z.EncBinary()
						_ = yym31
						if false {
						} else {
...
func (x codecSelfer1234) decSliceCronJob(v *[]CronJob, d *codec1978.Decoder) {
	...
	if yyl1 == 0 {
		...
		if yyl1 > cap(yyv1) {
			...
			yyrg1 := len(yyv1) > 0
			yyv21 := yyv1
			yyrl1, yyrt1 = z.DecInferLen(yyl1, z.DecBasicHandle().MaxInitLen, 1232)
			if yyrt1 {
				if yyrl1 <= cap(yyv1) {
					yyv1 = yyv1[:yyrl1]
				} else {
