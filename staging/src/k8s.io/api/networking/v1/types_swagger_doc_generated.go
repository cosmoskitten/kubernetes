...
var map_IPBlock = map[string]string{
	...
	"except": "Except is a slice of CIDRs that should not be included within an IP Block Valid examples are \"192.168.1.1/24\"",
}
...
var map_NetworkPolicyPeer = map[string]string{
	...
	"ipBlock":           "IPBlockSelector defines policy on a particular IPBlock",
}
