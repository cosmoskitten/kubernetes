...
var map_StorageClass = map[string]string{
	...
	"mountOptions":  "Dynamically provisioned PersistentVolumes of this storage class are created with these mountOptions. Not validated--mount of the PVs will simply fail if one is invalid.",
}
