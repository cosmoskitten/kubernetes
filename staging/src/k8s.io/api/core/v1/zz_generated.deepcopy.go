...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, creating a new CephFSPersistentVolumeSource.
func (x *CephFSPersistentVolumeSource) DeepCopy() *CephFSPersistentVolumeSource {
	if x == nil {
		return nil
	}
