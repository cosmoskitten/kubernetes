...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_NonResourceRule, InType: reflect.TypeOf(&NonResourceRule{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_ResourceAttributes, InType: reflect.TypeOf(&ResourceAttributes{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_ResourceRule, InType: reflect.TypeOf(&ResourceRule{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_SelfSubjectRulesReview, InType: reflect.TypeOf(&SelfSubjectRulesReview{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1beta1_SubjectRulesReviewStatus, InType: reflect.TypeOf(&SubjectRulesReviewStatus{})},
	)
}
...
// DeepCopy_v1beta1_NonResourceRule is an autogenerated deepcopy function.
func DeepCopy_v1beta1_NonResourceRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
// DeepCopy_v1beta1_ResourceRule is an autogenerated deepcopy function.
func DeepCopy_v1beta1_ResourceRule(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceRule)
...
// DeepCopy_v1beta1_SelfSubjectRulesReview is an autogenerated deepcopy function.
func DeepCopy_v1beta1_SelfSubjectRulesReview(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*SelfSubjectRulesReview)
		out := out.(*SelfSubjectRulesReview)
		*out = *in
		if err := DeepCopy_v1beta1_SubjectRulesReviewStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_v1beta1_SubjectRulesReviewStatus is an autogenerated deepcopy function.
func DeepCopy_v1beta1_SubjectRulesReviewStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.ResourceRules != nil {
			...
			*out = make([]ResourceRule, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_ResourceRule(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		if in.NonResourceRules != nil {
			...
			*out = make([]NonResourceRule, len(*in))
			for i := range *in {
				if err := DeepCopy_v1beta1_NonResourceRule(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
