...
type Event struct {
	...
	Object *corev1.ObjectReference `json:"object,omitempty" protobuf:"bytes,6,opt,name=object"`
	// Optional secondary Object for more complex actions.
	SecondaryObject *corev1.ObjectReference `json:"secondaryObject,omitempty" protobuf:"bytes,7,opt,name=secondaryObject"`
